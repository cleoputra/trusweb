			  ...
			  <header id="header" id="home">
		  		<div class="container main-menu">
			    	<div class="row align-items-center justify-content-between d-flex">
				      <div id="logo">
				        <a href="{{route('frontEnd.index')}}"><img src="{{asset('img/small_trus.png')}}" alt="" title="" /></a>
				      </div>
				      <nav id="nav-menu-container">
				        <ul class="nav-menu">
				          ...
				          <li><a href="{{route('frontEnd.porto')}}">Portofolio</a></li>
				          <li><a href="{{route('frontEnd.news')}}">News</a>   
