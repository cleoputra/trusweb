					...
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							<h1 class="text-white">
								...
								<p class="text-white link-nav"><a href="{{route('frontEnd.index')}}">Home </a>  <span class="lnr lnr-arrow-right"></span><a href="{{route('frontEnd.service')}}">Service </a> <span class="lnr lnr-arrow-right"></span> <a href="{{route('frontEnd.s_offshore')}}"> Offshore Development Services</a></p>
						</div>	
					</div>
				</div>
			</section>
