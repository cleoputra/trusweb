				...
				<div class="container">				
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="{{route('id_frontEnd.index')}}">Beranda </a>  <span class="lnr lnr-arrow-right"></span><a href="{{route('id_frontEnd.service')}}">Servis </a> <span class="lnr lnr-arrow-right"></span> <a href="{{route('id_frontEnd.s_customapp')}}"> Custom Application Development</a></p>
						</div>	
					</div>
				</div>
			</section>
							...
							<div class="navigation-area">
								<div class="row">
									<div class="col-lg-6 col-md-6 col-12 nav-left flex-row d-flex justify-content-start align-items-center">
										<div class="detials">
											<p>Prev Solutions</p>
											<a href="{{route('id_frontEnd.s_offshore')}}"><h4>Offshore Development Services</h4></a>
										</div>
									</div>
									<div class="col-lg-6 col-md-6 col-12 nav-right flex-row d-flex justify-content-end align-items-center">
										<div class="detials">
											<p>Next Solutions</p>
											<a href="{{route('id_frontEnd.s_web')}}"><h4>Web Developments</h4></a>
										</div>
