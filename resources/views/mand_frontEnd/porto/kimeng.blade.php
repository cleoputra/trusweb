                ...
                <div class="container">             
                    <div class="row d-flex align-items-center justify-content-center">
                        <div class="about-content col-lg-12">
                            ...
                            <p class="text-white link-nav"><a href="{{route('md_frontEnd.index')}}">主页 </a>  <span class="lnr lnr-arrow-right"></span>  <a href="{{route('md_frontEnd.porto')}}"> 制品</a> <span class="lnr lnr-arrow-right"></span> <a href="{{route('md_frontEnd.p_kimeng')}}"> Kim Eng Securities Application</a></p>
                        </div>  
                    </div>
                </div>
            </section>
