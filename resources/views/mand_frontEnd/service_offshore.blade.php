					...
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							<h1 class="text-white">
								...
								<p class="text-white link-nav"><a href="{{route('md_frontEnd.index')}}">Home </a>  <span class="lnr lnr-arrow-right"></span><a href="{{route('md_frontEnd.service')}}">Service </a> <span class="lnr lnr-arrow-right"></span> <a href="{{route('md_frontEnd.s_offshore')}}"> Offshore Development Services</a></p>
						</div>	
					</div>
				</div>
			</section>
							...
							<div class="navigation-area">
								<div class="row">
									<div class="col-lg-6 col-md-6 col-12 nav-left flex-row d-flex justify-content-start align-items-center">
										<div class="detials">
											<p>Prev Solution</p>
											<a href="{{route('md_frontEnd.s_migration')}}"><h4>Software Migration</h4></a>
										</div>
									</div>
									<div class="col-lg-6 col-md-6 col-12 nav-right flex-row d-flex justify-content-end align-items-center">
										<div class="detials">
											<p>Next Solution</p>
											<a href="{{route('md_frontEnd.s_customapp')}}"><h4>Custom Application Development</h4></a>
										</div>							
									</div>									
								</div>
							</div>
