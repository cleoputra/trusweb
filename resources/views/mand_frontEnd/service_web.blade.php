				...
				<div class="container">				
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="{{route('md_frontEnd.index')}}">Home </a>  <span class="lnr lnr-arrow-right"></span><a href="{{route('md_frontEnd.service')}}">Service </a> <span class="lnr lnr-arrow-right"></span> <a href="{{route('md_frontEnd.s_web')}}"> Web Development</a></p>
						</div>	
					</div>
				</div>
			</section>
